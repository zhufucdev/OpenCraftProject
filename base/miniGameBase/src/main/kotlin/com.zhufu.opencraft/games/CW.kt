...
class CW : GameBase() {
        ...
        private fun createNewGameWorld(id: Int,plugin: JavaPlugin): World {
            ...
            chunks.forEach { cnk ->
                ...
                while (true) {
                    ...
                    if (times >= 4000) {
                        throw WorldSpawnTimeOutException(w, "Unable to find suitable biome.")
                    }
                    times++
                }
                val chunk = r.chunk
    ...
    private val gameRuler = object : GameRuler() {
        ...
        override fun getPlayerLocation(info: Gaming.PlayerGamingInfo): Location = getLocationByTeam(info.team, world)
