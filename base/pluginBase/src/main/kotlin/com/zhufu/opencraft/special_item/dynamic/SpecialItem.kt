package com.zhufu.opencraft.special_item.dynamic
...
import com.zhufu.opencraft.special_item.dynamic.locate.*
...
abstract class SpecialItem : Tickable {
    companion object {
        // Utility
        ...
        private val prebuilt = Reflections("com.zhufu.opencraft.special_item")
            ...
            .filter {
                it.packageName.endsWith("special_item")
        ...
        fun getByItem(item: ItemStack, showing: Player? = null) =
    ...
    /**
     * Called if [SpecialItem.getByItem] is handed with the second parameter.
     */
