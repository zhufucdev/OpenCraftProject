...
interface PluginBase {
    ...
    fun getLang(player: OfflineInfo, value: String, vararg replaceWith: Any?): String = Language.got(lang = player.userLanguage, value = value, replaceWith = replaceWith)
    fun getLang(sender: CommandSender,value: String,vararg replaceWith: Any?): String{
        return if (sender is Player) {
            val info = OfflineInfo.findOfflinePlayer(sender.uniqueId)
    ...
    fun OfflinePlayer.offlineInfo() = OfflineInfo.findOfflinePlayer(uniqueId)
    ...
    fun broadcast(value: String,color: TextUtil.TextColor,vararg replaceWith: String?){
        ...
        Bukkit.getOnlinePlayers().forEach {
            val info = OfflineInfo.findOfflinePlayer(it.uniqueId)?:return@forEach
