...
class PlayerLocation(val player: OfflinePlayer, val itemID: UUID) : ItemLocation() {
    ...
    override val itemStack: ItemStack get() {
        push()
        return checkOnline().inventory.getItem(position)!!
    }
    ...
    companion object {
        ...
        fun deserialize(d: Map<String, Any>) =
            PlayerLocation(
                Bukkit.getOfflinePlayer(UUID.fromString(d["player"] as String)),
