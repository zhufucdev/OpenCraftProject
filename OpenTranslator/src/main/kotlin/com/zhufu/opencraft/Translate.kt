...
object Translate {
    ...
    fun translate(source: String,from: String = "auto",target: String,showTo: HumanEntity? = null): String{
        ...
        if (source.contains('$')){
            ...
            while (index != -1){
                ...
                result = result.replaceRange(index,end+1, "!*${if (showTo == null) Language.getDefault(value) else Language[showTo,value]}!*")
        ...
        toTranslate.forEach {
            ...
            if (it.translatable && !it.isExpr) {
                ...
                if (b == -1){
                    ...
                    var exception = ""
                    val expression = try { Parser.parse(expr) } catch (e: Exception) { exception = e.localizedMessage;null }
